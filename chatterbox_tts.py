...
# curl -X POST "https://stuarts205--chatterbox-tts-chatterbox-serve.modal.run/generate" \
#   -H "Content-Type: application/json" \
#   -H "X-Api-Key: my-super-secret-key-that-anyone-can-guess" \
#   -d '{"prompt": "Hello from Chatterbox [chuckle].", "voice_key": "voices/system/cmmphzr7j000db8x6md0u25bq"}' \
#   --output c:\lp\resonance\output.wav

# R2 cloud bucket mount (read-only, replaces Modal Volume)
R2_BUCKET_NAME = "resonance-app"
R2_ACCOUNT_ID = "38641942b7eb5e407efd859eead2e014"
R2_MOUNT_PATH = "/r2"
